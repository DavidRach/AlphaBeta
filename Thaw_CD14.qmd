...
Data <- Data |> mutate(CD14Freq = CD14/CD45) 

Data$CD14Freq <- round(Data$CD14Freq, 2)
```
...
ControlPlot  <- ControlPlot + labs(y="Monocytes per sample")
```
...
ControlPlotFreq  <- ControlPlotFreq + labs(y="Monocytes (% of CD45+ cells")
```
