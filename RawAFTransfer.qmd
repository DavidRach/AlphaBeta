...
CSVFiles <- list.files("data", pattern="ProcessedExperiments_AF.csv")

if (length(CSVFiles) == 0){
    ProcessedExperiments <- data.frame(Experiment="Test", Date="01-01-2000")
    filename <- "ProcessedExperiments_AF.csv"
...
CSV <- paste(                                                
      ...
      "DavidRach", "AlphaBeta",                   
      "main", "data", "ProcessedExperiments_AF.csv",                              
      sep = "/"                                             
    ) 
