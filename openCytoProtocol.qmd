...
walk(.f=ExperimentVisualized, .x=ExperimentsPresent, visualized=AlreadyVisualized, files=Samples, conditions=c("Ctrl", "PPD", "SEB"), template="GatesUnmixed.csv", UnityY="Spark Blue 550-A", UnityX="Pacific Blue-A", GatePlots=FALSE, RidgePlots=FALSE, UnityPlots=FALSE, OneByNPlots=FALSE, Docker=TRUE, Override=TRUE)
```
