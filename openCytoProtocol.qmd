...
walk(.f=ExperimentVisualized, .x=ExperimentsPresent[[1]], visualized=AlreadyVisualized, files=Samples, conditions=c("Ctrl"), template="GatesUnmixed.csv", UnityY="Spark Blue 550-A", UnityX="Pacific Blue-A",
