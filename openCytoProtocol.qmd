...
TheseFolders <- basename(ExperimentsPresent)

UpdatedData <- purrr::map(.x=TheseFolders, .f=ExperimentVisualized, parsed=AlreadyVisualized, parentFolder=OS) |> bind_rows()
