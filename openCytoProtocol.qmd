...
```{r}
walk(.f=ExperimentVisualized, .x=ExperimentsPresent[6], visualized=AlreadyVisualized, files=Samples, conditions=c("SEB"), template="GatesUnmixed.csv", UnityY="Spark Blue 550-A", UnityX="Pacific Blue-A", GatePlots=TRUE, RidgePlots=TRUE, UnityPlots=TRUE, OneByNPlots=TRUE, Docker=TRUE, Override=FALSE)
```
