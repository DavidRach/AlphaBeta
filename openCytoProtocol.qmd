...
walk(.f=ExperimentVisualized, .x=ExperimentsPresent, visualized=AlreadyVisualized, files=Samples, conditions="Ctrl", template="GatesUnmixed.csv", UnityY="Spark Blue 550-A")
```
