...
Data <- Data |> mutate(CD19Freq = CD19/CD45) 

Data$CD19Freq <- round(Data$CD19Freq, 2)
```
...
ControlPlot  <- ControlPlot + labs(y="B cells per sample")
```
...
ControlPlotFreq  <- ControlPlotFreq + labs(y="B cells (% of CD45+ cells")
```
